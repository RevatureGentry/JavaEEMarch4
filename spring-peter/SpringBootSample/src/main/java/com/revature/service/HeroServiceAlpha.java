...
import com.revature.exception.InvalidHeroException;
...
public class HeroServiceAlpha implements HeroService {
	...
	public boolean registerHero(Hero hero) {
		if(hero.getName().equals("")) {
			throw new InvalidHeroException("Hero name cannot be empty.");
		}
	...
	public Hero getHero(String name) {
		return heroRepository.findFirstByNameIgnoreCase(name);
	}
}
